...
#define KARAOKE_TMP_STATUS_FLAG       (1<<7)
...
{    
    ...
    KARAOKE_CMD_JUMP,                     /* JUMP *//* 跳播, aux = time, unit:ms, ret = EPDK_OK/EPDK_FAIL, pbuffer = 1表示要求精确跳播           */
...
//    KARAOKE_CMD_GET_F_FREE_SPACE,               /* 获取F磁盘剩余磁盘容量大小，单位MB                          */
    ...
    KARAOKE_CMD_SET_PITCH,
    KARAOKE_CMD_GET_PITCH,
    KARAOKE_CMD_SET_VPS,
    KARAOKE_CMD_GET_VPS,

	KARAOKE_CMD_SET_TRACK,                    //设置音轨 aux=单轨编号 pbuffer:开关
    KARAOKE_CMD_
...
typedef enum tag_KaraokeStatus          /* the status os cedar                  */
{
    ...
    KARAOKE_STAT_FF,                      /* fast forward                         */
    KARAOKE_STAT_RR,                      /* fast backward                        */
    KARAOKE_STAT_JUMP,                    /* jump                                 */
    KARAOKE_STAT_
} KaraokeStatus;
