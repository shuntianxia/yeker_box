...
__s32 BSP_ADDA_FM2ADC_Init(void);
	 
__s32 BSP_ADDA_FM2ADC_Exit(void);
	 
__s32 BSP_ADDA_LINEIN2ADC_Init(void);
 
__s32 BSP_ADDA_LINEIN2ADC_Exit(void);
