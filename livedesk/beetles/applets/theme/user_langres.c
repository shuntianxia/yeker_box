...
************************************************************************************************************************
*/
#ifndef  __USER_LANGRES_C__
#define  __USER_LANGRES_C__
...
/*
****************************************************************************************************
*Name        : user_langres_init
*Prototype   : __s32 user_langres_init( const char *file )
...
****************************************************************************************************
*/
__s32 user_langres_init( const char *file )
{
    if( file == NULL )
    {
        return EPDK_FAIL;
...
/*
****************************************************************************************************
*Name        : user_langres_exit
*Prototype   : void user_langres_exit( void )
*Arguments   : void
*Return      : void
...
/*
****************************************************************************************************
*Name        : user_langres_set_type
*Prototype   : __s32 user_langres_set_type( __u32 language_id )
...
****************************************************************************************************
*/
__s32 user_langres_set_type( __u32 language_id )
{
    lang_ID = language_id;
...
/*
****************************************************************************************************
*Name        : user_langres_get_type
*Prototype   : __s32 user_langres_get_type( void )
*Arguments   : void
...
****************************************************************************************************
*/
__s32 user_langres_get_type( void )
{
    return lang_ID;
}
...
/*
****************************************************************************************************
*Name        : user_langres_get_menu_len
*Prototype   : __s32 user_langres_get_menu_len( __u32 text_id )
...
****************************************************************************************************
*/
__s32 user_langres_get_menu_len( __u32 text_id )
{
    if( hlang == NULL )
    {
        return -1;
...
/*
****************************************************************************************************
*Name        : user_langres_get_menu_text
*Prototype   : __s32  user_langres_get_menu_text( __u16 text_id, void *buf, __u32 size )
*Arguments   : text_id        input. the ID of a menu text
...
****************************************************************************************************
*/
__s32 user_langres_get_menu_text( __u32 text_id, void *buf, __u32 size )
{
    __s32 ret;
...
#endif     //  ifndef __USER_LANGRES_C__

/* end of user_langres.c */
