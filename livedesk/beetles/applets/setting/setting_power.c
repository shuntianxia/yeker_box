...
{
	{ STRING_SET_POWER_BGT_EX,0},	// 0
	{ STRING_SET_POWER_BGT_OFF_EX,0},	// 1
	{ STRING_SET_POWER_OFF_EX,0},		// 2
};

static setting_item_id_t setting_power_res_id[] =
{
	{STRING_SET_POWER_BGT_EX,STRING_SET_POWER_BGT_DE, STRING_SET_POWER_BGT_TITLE,STRING_SET_POWER_BGT_LEVEL1_CON,0,0},	// 0
	{STRING_SET_POWER_BGT_OFF_EX, STRING_SET_POWER_BGT_OFF_DE,STRING_SET_POWER_BGT_OFF_TITLE,STRING_SET_POWER_BGT_NEVER_CON,0,0},	// 1
	{STRING_SET_POWER_OFF_EX, STRING_SET_POWER_OFF_DE,STRING_SET_POWER_OFF_TITLE,STRING_SET_POWER_OFF_NEVER_CON,0,0},		// 2
};
...
static void _setting_power_res_init(setting_power_attr_t *power_attr)
{
	...
	power_attr->h_bmp_big_setting = theme_open(0);
	power_attr->h_bmp_prompt= theme_open(0);
	power_attr->h_bmp_bottom= theme_open(0);
