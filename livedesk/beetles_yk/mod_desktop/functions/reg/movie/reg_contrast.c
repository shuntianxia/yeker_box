...
************************************************************************************************************************
*/
#ifndef  __REG_CONTRAST_C__
#define  __REG_CONTRAST_C__


#include "..\\reg_i.h"


#define REG_CONTRAST_REGNODE             "\\movie\\contrast"
#define REG_CONTRAST_SET                 "contrast"
#define REG_CONTRAST_KEY_CURRENT         "current"
#define REG_CONTRAST_KEY_DEFAULT         "default"
...
****************************************************************************************************
*/
__u32  lion_reg_contrast_get( void )
{
    __hdle  h_node = NULL;
    ...
    /* open reg node */
	h_node = eLIBs_RegOpenNode( REG_CONTRAST_REGNODE, ELIBS_REG_READONLY );
	if( h_node == NULL )
	{
		__wrn("Warning! Reg node %s cannot be opened!\n", REG_CONTRAST_REGNODE);
	    goto error;
	}
    
    /* get key value */
    eLIBs_RegGetKeyValue( h_node, REG_CONTRAST_SET, REG_CONTRAST_KEY_CURRENT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_contrast_set( __u32 value )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
    
    /* open reg node */
	h_node = eLIBs_RegOpenNode( REG_CONTRAST_REGNODE, ELIBS_REG_READWRITE );
	if( h_node == NULL )
	{
		__wrn("Warning! Reg node %s cannot be opened!\n", REG_CONTRAST_REGNODE);
	    goto error;
    ...
    /* set key value */
    eLIBs_RegSetKeyValue( h_node, REG_CONTRAST_SET, REG_CONTRAST_KEY_CURRENT, key_value );
...
****************************************************************************************************
*/
__u32 lion_reg_contrast_get_default( void )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
    __u32   ret;
    ...
    /* get key value */
    eLIBs_RegGetKeyValue( h_node, REG_CONTRAST_SET, REG_CONTRAST_KEY_DEFAULT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_contrast_restore( void )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
