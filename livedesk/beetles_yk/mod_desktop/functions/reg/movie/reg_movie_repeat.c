...
************************************************************************************************************************
*/
#ifndef  __REG_MOVIE_REPEAT_C__
#define  __REG_MOVIE_REPEAT_C__


#include "..\\reg_i.h"


#define REG_MOVIE_REPEAT_REGNODE             "\\movie\\repeat"
#define REG_MOVIE_REPEAT_SET                 "repeat"
#define REG_MOVIE_REPEAT_KEY_CURRENT         "current"
#define REG_MOVIE_REPEAT_KEY_DEFAULT         "default"
...
****************************************************************************************************
*/
orc_play_mode_e lion_reg_movie_repeat_get( void )
{
    __hdle  h_node = NULL;
    ...
    /* open reg node */
	h_node = eLIBs_RegOpenNode( REG_MOVIE_REPEAT_REGNODE, ELIBS_REG_READONLY );
	if( h_node == NULL )
	{
		__wrn("Warning! Reg node %s cannot be opened!\n", REG_MOVIE_REPEAT_REGNODE);
	    goto error;
	}
    
    /* get key value */
    eLIBs_RegGetKeyValue( h_node, REG_MOVIE_REPEAT_SET, REG_MOVIE_REPEAT_KEY_CURRENT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_movie_repeat_set( orc_play_mode_e repeat )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
    __s32   ret;
    ...
    /* open reg node */
	h_node = eLIBs_RegOpenNode( REG_MOVIE_REPEAT_REGNODE, ELIBS_REG_READWRITE );
	if( h_node == NULL )
	{
		__wrn("Warning! Reg node %s cannot be opened!\n", REG_MOVIE_REPEAT_REGNODE);
	    goto error;
    ...
    /* set key value */
    eLIBs_RegSetKeyValue( h_node, REG_MOVIE_REPEAT_SET, REG_MOVIE_REPEAT_KEY_CURRENT, key_value );
...
****************************************************************************************************
*/
orc_play_mode_e lion_reg_movie_repeat_get_default( void )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
    orc_play_mode_e  ret;
    ...
    /* get key value */
    eLIBs_RegGetKeyValue( h_node, REG_MOVIE_REPEAT_SET, REG_MOVIE_REPEAT_KEY_DEFAULT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_movie_repeat_restore( void )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
...
const static repeat_map_t repeat_map_tbl[ ] =
{
    ...
    { LION_REPEAT_NAME_RANDOM    , ORC_PLAY_MODE_RANDOM     }
};
...
#endif     //  ifndef __REG_MOVIE_REPEAT_C__

/* end of reg_movie_repeat.c */
