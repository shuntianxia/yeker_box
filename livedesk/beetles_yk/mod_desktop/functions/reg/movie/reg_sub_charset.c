...
************************************************************************************************************************
*/
#ifndef  __REG_SUB_CHARSET_C__
#define  __REG_SUB_CHARSET_C__


#include "..\\reg_i.h"


#define REG_SUB_CHARSET_REGNODE             "\\system\\sub_charset"
#define REG_SUB_CHARSET_SET                 "sub_charset"
#define REG_SUB_CHARSET_KEY_CURRENT         "current"
#define REG_SUB_CHARSET_KEY_DEFAULT         "default"
...
****************************************************************************************************
*/
__epdk_charset_enm_e lion_reg_sub_charset_get( void )
{
    __hdle  h_node = NULL;
    ...
    /* open reg node */
	h_node = eLIBs_RegOpenNode( REG_SUB_CHARSET_REGNODE, ELIBS_REG_READONLY );
	if( h_node == NULL )
	{
		__wrn("Warning! Reg node %s cannot be opened!\n", REG_SUB_CHARSET_REGNODE);
	    goto error;
	}
    
    /* get key value */
    eLIBs_RegGetKeyValue( h_node, REG_SUB_CHARSET_SET, REG_SUB_CHARSET_KEY_CURRENT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_sub_charset_set( __epdk_charset_enm_e sub_charset )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
    __s32   ret;
    ...
    /* open reg node */
	h_node = eLIBs_RegOpenNode( REG_SUB_CHARSET_REGNODE, ELIBS_REG_READWRITE );
	if( h_node == NULL )
	{
		__wrn("Warning! Reg node %s cannot be opened!\n", REG_SUB_CHARSET_REGNODE);
	    goto error;
    ...
    /* convert the format of the key value */
    ret = eLIBs_charset_enm2name( sub_charset, key_value );
    if( ret != 0 )
    {
        goto error;
    }
    ...
    /* set key value */
    eLIBs_RegSetKeyValue( h_node, REG_SUB_CHARSET_SET, REG_SUB_CHARSET_KEY_CURRENT, key_value );
...
****************************************************************************************************
*/
__epdk_charset_enm_e lion_reg_sub_charset_get_default( void )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
    __epdk_charset_enm_e  ret;
    ...
    /* get key value */
    eLIBs_RegGetKeyValue( h_node, REG_SUB_CHARSET_SET, REG_SUB_CHARSET_KEY_DEFAULT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_sub_charset_restore( void )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
...
#endif     //  ifndef __REG_SUB_CHARSET_C__

/* end of reg_sub_charset.c */
