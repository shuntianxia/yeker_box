...
************************************************************************************************************************
*/
#ifndef  __REG_SWITCH_TIME_C__
#define  __REG_SWITCH_TIME_C__


#include "..\\reg_i.h"


#define REG_SWITCH_TIME_REGNODE             "\\photo\\switch_time"
#define REG_SWITCH_TIME_SET                 "switch_time"
#define REG_SWITCH_TIME_KEY_CURRENT         "current"
#define REG_SWITCH_TIME_KEY_DEFAULT         "default"
...
****************************************************************************************************
*/
__s32  lion_reg_switch_time_get( void )
{
    __hdle  h_node = NULL;
    ...
    /* open reg node */
	h_node = eLIBs_RegOpenNode( REG_SWITCH_TIME_REGNODE, ELIBS_REG_READONLY );
	if( h_node == NULL )
	{
		__wrn("Warning! Reg node %s cannot be opened!\n", REG_SWITCH_TIME_REGNODE);
	    goto error;
	}
    
    /* get key value */
    eLIBs_RegGetKeyValue( h_node, REG_SWITCH_TIME_SET, REG_SWITCH_TIME_KEY_CURRENT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_switch_time_set( __s32 time )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
    
    /* open reg node */
	h_node = eLIBs_RegOpenNode( REG_SWITCH_TIME_REGNODE, ELIBS_REG_READWRITE );
	if( h_node == NULL )
	{
		__wrn("Warning! Reg node %s cannot be opened!\n", REG_SWITCH_TIME_REGNODE);
	    goto error;
    ...
    /* set key value */
    eLIBs_RegSetKeyValue( h_node, REG_SWITCH_TIME_SET, REG_SWITCH_TIME_KEY_CURRENT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_switch_time_get_default( void )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
    __u32   ret;
    ...
    /* get key value */
    eLIBs_RegGetKeyValue( h_node, REG_SWITCH_TIME_SET, REG_SWITCH_TIME_KEY_DEFAULT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_switch_time_restore( void )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
...
#endif     //  ifndef __REG_SWITCH_TIME_C__

/* end of reg_switch_time.c */
