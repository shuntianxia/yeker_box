...
*											       All Rights Reserved
*
* File Name   : reg_lcd_saturation.c
*
* Author      : Gary.Wang
*
* Version     : 1.0
...
************************************************************************************************************************
*/
#ifndef  __REG_LCD_SATURATION_C__
#define  __REG_LCD_SATURATION_C__


#include "..\\reg_i.h"


#define REG_LCD_SATURATION_REGNODE             "\\system\\lcd_saturation"
#define REG_LCD_SATURATION_SET                 "lcd_saturation"
#define REG_LCD_SATURATION_KEY_CURRENT         "current"
#define REG_LCD_SATURATION_KEY_DEFAULT         "default"
...
****************************************************************************************************
*/
__u32  lion_reg_lcd_saturation_get( void )
{
    __hdle  h_node = NULL;
    ...
    /* open reg node */
	h_node = eLIBs_RegOpenNode( REG_LCD_SATURATION_REGNODE, ELIBS_REG_READONLY );
	if( h_node == NULL )
	{
		__wrn("Warning! Reg node %s cannot be opened!\n", REG_LCD_SATURATION_REGNODE);
	    goto error;
	}
    
    /* get key value */
    eLIBs_RegGetKeyValue( h_node, REG_LCD_SATURATION_SET, REG_LCD_SATURATION_KEY_CURRENT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_lcd_saturation_set( __u32 value )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
    
    /* open reg node */
	h_node = eLIBs_RegOpenNode( REG_LCD_SATURATION_REGNODE, ELIBS_REG_READWRITE );
	if( h_node == NULL )
	{
		__wrn("Warning! Reg node %s cannot be opened!\n", REG_LCD_SATURATION_REGNODE);
	    goto error;
    ...
    /* set key value */
    eLIBs_RegSetKeyValue( h_node, REG_LCD_SATURATION_SET, REG_LCD_SATURATION_KEY_CURRENT, key_value );
...
****************************************************************************************************
*/
__u32 lion_reg_lcd_saturation_get_default( void )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
    __u32   ret;
    ...
    /* get key value */
    eLIBs_RegGetKeyValue( h_node, REG_LCD_SATURATION_SET, REG_LCD_SATURATION_KEY_DEFAULT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_lcd_saturation_restore( void )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
...
#endif     //  ifndef __REG_LCD_SATURATION_C__

/* end of reg_lcd_saturation.c */
