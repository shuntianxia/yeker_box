...
************************************************************************************************************************
*/
#ifndef  __REG_VOLUME_C__
#define  __REG_VOLUME_C__


#include "..\\reg_i.h"


#define REG_VOLUME_REGNODE             "\\system\\volume"
#define REG_VOLUME_SET                 "volume"
#define REG_VOLUME_KEY_CURRENT         "current"
#define REG_VOLUME_KEY_DEFAULT         "default"
...
****************************************************************************************************
*/
__u32  lion_reg_volume_get( void )
{
    __hdle  h_node = NULL;
    ...
    /* open reg node */
	h_node = eLIBs_RegOpenNode( REG_VOLUME_REGNODE, ELIBS_REG_READONLY );
	if( h_node == NULL )
	{
    ...
    /* get key value */
    eLIBs_RegGetKeyValue( h_node, REG_VOLUME_SET, REG_VOLUME_KEY_CURRENT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_volume_set( __u32 volume )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
    
    /* open reg node */
	h_node = eLIBs_RegOpenNode( REG_VOLUME_REGNODE, ELIBS_REG_READWRITE );
	if( h_node == NULL )
	{
		__wrn("Warning! Reg node %s cannot be opened!\n", REG_VOLUME_REGNODE);
	    goto error;
    ...
    /* convert the format of the key value */
    eLIBs_int2str_dec( volume, key_value );
    
    /* set key value */
    eLIBs_RegSetKeyValue( h_node, REG_VOLUME_SET, REG_VOLUME_KEY_CURRENT, key_value );
...
****************************************************************************************************
*/
__u32 lion_reg_volume_get_default( void )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
    __u32   ret;
    ...
    /* get key value */
    eLIBs_RegGetKeyValue( h_node, REG_VOLUME_SET, REG_VOLUME_KEY_DEFAULT, key_value );
...
****************************************************************************************************
*/
__s32 lion_reg_volume_restore( void )
{
    __hdle  h_node = NULL;
    char    key_value[ELIBS_KEY_VALUE_LEN+1];   
